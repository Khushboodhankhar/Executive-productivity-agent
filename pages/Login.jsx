...
export default function Login() {
  ...
  const handleLogin = (e) => {
    ...
    // Backend authentication baad mein connect kar sakte hain.
    navigate("/dashboard");
  };
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-lg rounded-2xl shadow-2xl p-8">
          ...
          <form onSubmit={handleLogin}>
            ...
            <button
              type="submit"
              className="w-full bg-gradient-to-r from-orange-500 to-pink-500 hover:from-orange-600 hover:to-pink-600 text-white font-semibold py-3 rounded-lg transition duration-200"
            >
              Sign In
            </button>
